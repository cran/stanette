...
//WW extension to stan
add("lkj_cov_log_fake", 
	bare_expr_type(double_type()), 
	bare_expr_type(matrix_type()), 
	bare_expr_type(vector_type()), 
	bare_expr_type(vector_type()), 
 ...
 add("generic_ode_interface", bare_expr_type(vector_type()),
     bare_expr_type(vector_type()),  // parameters
     bare_expr_type(vector_type()),  // initials
     bare_expr_type(vector_type()),  // obs times
     bare_expr_type(vector_type()),  // evid
     bare_expr_type(vector_type()),  // dose amt
     bare_expr_type(double_type()),  // absolute_tolerance
     bare_expr_type(double_type()),  // relative_tolerance
     bare_expr_type(int_type()),     // number of observations
     bare_expr_type(int_type()));    // which cmpt to observe
 
 //testing only
 add("generic_ode_interface_covar", bare_expr_type(vector_type()),
     bare_expr_type(vector_type()),  // parameters
     bare_expr_type(vector_type()),  // initials
     bare_expr_type(vector_type()),  // obs times
     bare_expr_type(vector_type()),  // evid
     bare_expr_type(vector_type()),  // dose amt
     bare_expr_type(vector_type()),  // covar
     bare_expr_type(double_type()),  // absolute_tolerance
     bare_expr_type(double_type()),  // relative_tolerance
     bare_expr_type(int_type()),     // number of observations
     bare_expr_type(int_type()));    // which cmpt to observe
 ...
 add("generic_cmt_interface", bare_expr_type(vector_type()),
     bare_expr_type(vector_type()),  // obs times
     bare_expr_type(vector_type()),  // dose_time
     bare_expr_type(vector_type()),  // dose amt
     bare_expr_type(vector_type()),  // Tinf
     bare_expr_type(vector_type()),  // parameters
     bare_expr_type(int_type()),     // ncmt
     bare_expr_type(int_type()),     // oral?
     bare_expr_type(int_type()),     // infusion?
     bare_expr_type(int_type()));    // parameterization
 
 
 add("linear_cmpt_1order_absor", bare_expr_type(vector_type()),
     bare_expr_type(vector_type()),  // obs times
     bare_expr_type(vector_type()),  // dose_time
     bare_expr_type(vector_type()),  // dose amt
     bare_expr_type(vector_type()),  // parameters
 ...
 add("linear_cmpt_iv_bolus", bare_expr_type(vector_type()),
     bare_expr_type(vector_type()),  // obs times
     bare_expr_type(vector_type()),  // dose_time
     bare_expr_type(vector_type()),  // dose amt
     bare_expr_type(vector_type()),  // parameters
 ...
 add("linear_cmpt_iv_infusion", bare_expr_type(vector_type()),
     bare_expr_type(vector_type()),  // obs times
     bare_expr_type(vector_type()),  // dose_time
     bare_expr_type(vector_type()),  // dose amt
     bare_expr_type(vector_type()),  // Tinf
